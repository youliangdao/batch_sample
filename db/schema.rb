...
ActiveRecord::Schema.define(version: 2022_12_06_044838) do
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", comment: "ゲームのユーザー情報を格納するテーブル", force: :cascade do |t|
